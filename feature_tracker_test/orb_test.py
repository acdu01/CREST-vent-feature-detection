...
# Load JPG image
image = imread(r"C:\202425\crest\feature_tracker_test\test_data\image.jpg")  # Reads as NumPy array

# Ensure it has 3 RGB channels (some JPGs might have an alpha channel)
if image.shape[-1] == 4:
    image = image[:, :, :3]  # Remove alpha channel if present

# Ensure data type matches `astronaut`
